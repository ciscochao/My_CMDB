# coding=utf-8
"""
# @Time    : 9/16/19 4:47 PM
# @Author  : F0rGeEk@root
# @Email   : bat250@protonmail.com
# @File    : collect_linux_info.py
# @Software: PyCharm
***********************************************************
███████╗ ██████╗ ██████╗  ██████╗ ███████╗███████╗██╗  ██╗
██╔════╝██╔═████╗██╔══██╗██╔════╝ ██╔════╝██╔════╝██║ ██╔╝
...
def collect():
    ...
    col_data = dict()
    col_data['asset_type'] = 'server'
    col_data['manufacturer'] = raw_data['Manufacturer']
    col_data['sn'] = raw_data['Serial Number']
    col_data['model'] = raw_data['Product Name']
...
def get_cpu_info():
    ...
    if len(cpu_model) > 1:
        cpu_data["cpu_model"] = cpu_model[1].strip()
    else:
        cpu_data["cpu_model"] = ''
